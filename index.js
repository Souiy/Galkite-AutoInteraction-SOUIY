...
function displayBanner() {
  ...
  console.log(chalk.cyanBright(' '.repeat((width - 40) / 2) + '=== TIKTOK 🚀 : AirdropRefferal (@souiy1) ==='));
  console.log(chalk.yellowBright(' '.repeat((width - 33) / 2) + '✪ KITE AI AUTO DAILY QUIZ & CHAT AI ✪\n'));
console.log("✪ Satukan Solidaritas Bantu Palestina! ");
console.log("✪ Innalillahi! Lebih dari 50.983 syahid terbunuh ");
console.log("✪ 70% korban anak-anak dan perempuan. Kuatkan solidaritas sekarang! ");
console.log("✪ Link Donasi https://digital.dompetdhuafa.org/donasi/jagapalestina ");
